...
#define HEATER_0_PIN       6    // EXTRUDER 1
...
#define SDCARDDETECT -1
#define MALYAN_LCD		1
#define DUAL_MAX6675	1
#define MALYAN_DIGIPOT	1
#define MOTOR_X_CURRENT	57
#define MOTOR_Y_CURRENT	61
#define MOTOR_Z_CURRENT 65
#define MOTOR_AB_SCL	27
//#define MOTOR_AB_SDA	27

#define MOTOR_AB_SDA_P	      (PINJ&(1<<6))
#define MOTOR_AB_SDA_I		  DDRJ&=~(1<<6)
#define MOTOR_AB_SDA_O		  DDRJ|=(1<<6)
#define MOTOR_AB_SDA_H        PORTJ|=(1<<6)
#define MOTOR_AB_SDA_L        PORTJ&=~(1<<6)
